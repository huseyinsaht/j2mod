 ...
 */
public class FC42WriteRequest extends ModbusRequest {

	public final static int FUNCTION_CODE = 0x42;
	...
	/**
	 * Constructs a new <tt>FC42WriteRequest</tt> instance with a given starting
	 * reference and values to be written.
	 * <p>
	 *
	 * @param first     -- the address of the first register to write to.
	 * @param registers -- the registers to be written.
	 */
	public FC42WriteRequest(int first, Register[] registers) {
	...
	/**
	 * Constructs a new <tt>FC42WriteRequest</tt> instance.
	 */
	public FC42WriteRequest() {
		setFunctionCode(FUNCTION_CODE);
		setDataLength(5);
	}
	...
	public ModbusResponse createResponse(AbstractModbusListener listener) {
		...
		if (nonWordDataHandler == null) {
			...
			response = (FC42WriteResponse) getResponse();
