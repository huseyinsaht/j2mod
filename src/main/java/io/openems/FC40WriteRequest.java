 ...
 */
public class FC40WriteRequest extends ModbusRequest {
	 ...
	 */
	public FC40WriteRequest(int first, Register[] registers) {
...
//		setDataLength(5);
	...
	public ModbusResponse createResponse(AbstractModbusListener listener) {
		...
		if (nonWordDataHandler == null) {
			...
			response = (FC40WriteResponse) getResponse();
