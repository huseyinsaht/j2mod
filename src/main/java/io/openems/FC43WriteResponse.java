 ...
 */
public class FC43WriteResponse extends ModbusResponse {
	// instance attributes
	 ...
	 */
	public FC43WriteResponse() {
		super();

		setFunctionCode(FC40WriteRequest.FUNCTION_CODE);
		setDataLength(4);
	}
	 ...
	 */
	public FC43WriteResponse(int reference, int wordCount) {
		super();
	...
	/**
	 * Returns the number of words that have been written. The returned value should
	 * be half of the byte count of the response.
	 * <p>
	 *
