 ...
 */
public class FC43WriteRequest extends ModbusRequest {

	public final static int FUNCTION_CODE = 0x43;
	 ...
	 */
	public FC43WriteRequest(int first, Register[] registers) {
...
//		setDataLength(5);
	...
	public ModbusResponse createResponse(AbstractModbusListener listener) {
		...
		if (nonWordDataHandler == null) {
			...
			response = (FC43WriteResponse) getResponse();
