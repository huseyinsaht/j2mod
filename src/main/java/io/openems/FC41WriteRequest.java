 ...
 */
public class FC41WriteRequest extends ModbusRequest {

	public final static int FUNCTION_CODE = 0x41;
	 ...
	 */
	public FC41WriteRequest(int first, Register[] registers) {
	...
	public ModbusResponse createResponse(AbstractModbusListener listener) {
		...
		if (nonWordDataHandler == null) {
			...
			response = (FC41WriteResponse) getResponse();
