 ...
 */
public class FC42WriteResponse extends ModbusResponse {
	// instance attributes
	 ...
	 */
	public FC42WriteResponse() {
		super();

		setFunctionCode(FC42WriteRequest.FUNCTION_CODE);
		setDataLength(4);
	}
	 ...
	 */
	public FC42WriteResponse(int reference, int wordCount) {
		super();
